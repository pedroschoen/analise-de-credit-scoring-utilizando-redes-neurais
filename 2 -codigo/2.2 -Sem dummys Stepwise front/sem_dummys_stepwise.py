...
ks_max = ks_base
var_max = []
colocar = ['default payment next month']
...
while stop:
    ...
    for i in columns:
        ...
        try:
            colocar.append(i)
            print ('Testing inputing: ',colocar)
            train = base_treino[colocar]
            test = base_teste[colocar]
            ks_atual = modelo(train,test,colocar)
    ...
    if (melhor == 0):
        ...
        colocar.append(var_max[0])
        columns.remove(var_max[0])
        var_min=[]